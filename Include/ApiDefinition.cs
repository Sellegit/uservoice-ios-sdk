...
namespace UserVoice {
	...
	public partial interface UVStyleSheet {
		...
		[Static, Export ("instance"), Verify ("ObjC method massaged into getter property", "/Users/dementrock/coding/uservoice-ios-sdk/Include/UVStyleSheet.h", Line = 14)]
	...
	public partial interface UVConfig {
		...
		[Export ("traits"), Verify ("ObjC method massaged into getter property", "/Users/dementrock/coding/uservoice-ios-sdk/Include/UVConfig.h", Line = 40)]
		...
		[Export ("attachments"), Verify ("ObjC method massaged into getter property", "/Users/dementrock/coding/uservoice-ios-sdk/Include/UVConfig.h", Line = 46), Verify ("NSArray may be reliably typed, check the documentation", "/Users/dementrock/coding/uservoice-ios-sdk/Include/UVConfig.h", Line = 46)]
	...
	public partial interface UserVoice {
		...
		[Static, Export ("getUserVoiceContactUsFormForModalDisplay"), Verify ("ObjC method massaged into getter property", "/Users/dementrock/coding/uservoice-ios-sdk/Include/UserVoice.h", Line = 35)]
		UIViewController GetUserVoiceContactUsFormForModalDisplay { get; }

		[Static, Export ("delegate"), Verify ("ObjC method massaged into setter property", "/Users/dementrock/coding/uservoice-ios-sdk/Include/UserVoice.h", Line = 38), Verify ("Backing getter method to ObjC property removed: delegate", "/Users/dementrock/coding/uservoice-ios-sdk/Include/UserVoice.h", Line = 41)]
		UVDelegate Delegate { get; set; }

		[Static, Export ("bundle"), Verify ("ObjC method massaged into getter property", "/Users/dementrock/coding/uservoice-ios-sdk/Include/UserVoice.h", Line = 44)]
		NSBundle Bundle { get; }

		[Static, Export ("version"), Verify ("ObjC method massaged into getter property", "/Users/dementrock/coding/uservoice-ios-sdk/Include/UserVoice.h", Line = 47)]
		string Version { get; }
